...
mixin BasicPage<Page extends BaseStatefulWidget> on BaseState<Page> {
  ...
  /// Use this method inside dispose to cancel request on widget dispose
  void cancelRequest({required CancelToken cancelToken}) {
    apiService.cancelAPI(cancelToken: cancelToken);
  }
}
